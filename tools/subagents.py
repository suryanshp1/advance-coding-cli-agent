...
class SubAgentTool(Tool):
    ...
    async def execute(self, invocation: ToolInvocation) -> ToolResult:
        from agent.agent import Agent, AgentEvent, AgentEventType
